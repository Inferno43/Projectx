              ...
              /*  contractorList = new RealmList<>();
                ...
                mAdapter = new ContractAdapter(context, contractorList, new OnclickListener() {
                    ...
                    public void onClick(int position) {
                        Toast.makeText(context,""+contractorList.get(position).getContractorName(),Toast.LENGTH_LONG).show();
                        Bundle extras = new Bundle();
                        //extras.putSerializable(AppConstants.EXTRA_CONTRACTOR,contractorList.get(position));
