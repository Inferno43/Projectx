...
//                mAdapter = new ChooseWorkersAdapter(context, workerList, new ChooseItem() {
//                    @Override
//                    public void onItemClicked(int position,boolean isSelected) {
//                        Log.i("WorkerModel",""+position+" selected "+workerList.get(position).isWorkerSelected());//test log
//                    }
//                });
//
